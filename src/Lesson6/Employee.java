...
public class Employee {
    ...
    //boolean setters
    //if incoming data breaks the rules the propertey WONT get set- false returned
    //if incoming data is okay, prooperty is set, and true is returned
    // this accomplishes 2 things
    //1) Protects the property from being set to "bad data" 
    //2)Sends a signal back to clinet class to let it know if property  was set or not
